...
def userviz():
    ...
    return render_template('userViz.html', username = username, sport_pyramid = sport_pyramid, trad_pyramid = trad_pyramid, boulder_pyramid = boulder_pyramid, user_ticks = user_ticks, binned_code_dict = binned_code_dict)
